...
class FiledNPArray:
    ...
    def value(self):
        ...
        return np.array(FiledVariable(self.name, inner).value)
...
def get_alt_matrix():
    ...
    return FiledNPArray('alt_lk.alt', inner).value
...
def get_latlng_matrix():
    ...
    return FiledNPArray('alt_lk.latlng', inner).value
...
def get_distance_matrix(latlng0):
    ...
    return FiledNPArray('alt_lk.distance', inner).value
...
def get_alpha_matrix(latlng0):
    ...
    return FiledNPArray('alt_lk.alpha', inner).value
...
def get_beta_matrix(latlng0):
    ...
    return FiledNPArray('alt_lk.beta', inner).value
